...
class PayForCoins extends StatefulWidget {
  final String currentUserId;
  final UserVariables variables;
  int coins;
  double SubTotal;

  PayForCoins({this.currentUserId, this.variables, this.SubTotal, this.coins});

  @override
  _PayForCoinsState createState() => _PayForCoinsState();
}

class _PayForCoinsState extends State<PayForCoins>
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Container(
                    width: width*0.6,
                    child: Text(widget.coins.toString() + ' coins', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16, fontFamily: 'Muli'), overflow: TextOverflow.clip, textAlign: TextAlign.start,),
