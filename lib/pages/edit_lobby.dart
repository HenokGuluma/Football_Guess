        ...
        child: ListView(
         /*  mainAxisAlignment: MainAxisAlignment.center,
          ...
          children: [
            ...
            Center(
              child: Text(
                'Edit this Lobby', style: TextStyle(color: Color(0xff00ffff), fontFamily: 'Muli', fontSize: 30, fontWeight: FontWeight.w900, fontStyle: FontStyle.italic),
              ),
            ),
         ...
         Row(
          ...
          builder: (BuildContext context) {
            ...
            child: Container(
              ...
              height: height*0.06,
              child: Center(
                child: Text(creating?'Choosing Game...':'Choose Game', style: TextStyle(color: Colors.black, fontSize: 18, fontFamily: 'Muli', fontWeight: FontWeight.w900)),
              ),
            ),
            )
            :Container(
