...
class BuyTokens extends StatefulWidget {
  ...
  BuyTokens({this.variables});

  @override
  BuyTokensState createState() => BuyTokensState();
}

class BuyTokensState extends State<BuyTokens> {
  File _image;
  File imageFile;
    ...
    return Scaffold(
        ...
        body:  Center(
          ...
          Container(
              ...
              height: height*0.05,
              child: Center(
                child: Text('Enter amount of tokens', style: TextStyle(color: Color(0xff00ffff), fontSize: 25, fontFamily: 'Muli', fontWeight: FontWeight.w900)),
              ),
            ),
